...
public class PlayerControlsDemoActivity extends YouTubeFailureRecoveryActivity implements
    ...
    private static final ListEntry[] ENTRIES = {
            ...
            new ListEntry("[Services] Présentation des applications et logiciels Vertin Go Website en libre accès pour en profiter de l'expérience!", "PLkVcopFUsyo5HE1ZVU1mK8y_4Z5AMuNyp", true),
            new ListEntry("Editeur de Jeux Videos Unity", "PLkVcopFUsyo6XOEiFnY5HmWYikU5wmHH9", true),
            new ListEntry("[Tutos] Deviens un développeur avec les tutos informatiques de Vertin Go Website!", "PLkVcopFUsyo7ReESgIUBCT4A7QLHeMZ3q",true),
            ...
            new ListEntry("[Démo] Présentation et configuration du système marketing en ligne My Power Lead System!", "PLkVcopFUsyo488EzmEwKGazh3annYKnk7", true),
            new ListEntry("[Tuto] Logiciel Video Marketing Vidneos", "PLkVcopFUsyo4IfkN8e7OlXK0arAFe9pvJ",true),
           };
